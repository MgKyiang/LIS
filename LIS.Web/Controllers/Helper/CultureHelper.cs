...
namespace LIS.Web.Controllers.Helper {
    public static class CultureHelper
    {
        ...
        public static string MyanmarNumberToEnglishNumber(string input)
        {
            if (input != null)
            {

                input = input.Replace("၀", "0");
                input = input.Replace("၁", "1");
                input = input.Replace("၂", "2");
                input = input.Replace("၃", "3");
                input = input.Replace("၄", "4");
                input = input.Replace("၅", "5");
                input = input.Replace("၆", "6");
                input = input.Replace("၇", "7");
                input = input.Replace("၈", "8");
                input = input.Replace("၉", "9");
                return input;
            }
            else
            {
        ...
        public static string EnglishNumberToMyanmarNumber(string input)
        {
            if (input != null)
            {
                input = input.Replace("0", "၀");
                input = input.Replace("1", "၁");
                input = input.Replace("2", "၂");
                input = input.Replace("3", "၃");
                input = input.Replace("4", "၄");
                input = input.Replace("5", "၅");
                input = input.Replace("6", "၆");
                input = input.Replace("7", "၇");
                input = input.Replace("8", "၈");
                input = input.Replace("9", "၉");
                return input;
            }
            else
            {
